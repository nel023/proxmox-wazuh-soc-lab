...
The image below shows the Proxmox node dashboard after completing the installation and configuration steps. All expected VMs (Wazuh Server, Infra Services, Windows 10 Agent, Ubuntu Agent, Kali VM) are listed in the left panel, confirming successful deployment.
